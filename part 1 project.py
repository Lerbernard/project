...
while x == 0:
    ...
    if operation == "+":
        ...
        add_number_1 = input("first number you want to add: ")
        add_number_2 = input("second number you want to add: ")

        add_real_number_1 = int(add_number_1)
        add_real_number_2 = int(add_number_2)

        addition = add_real_number_1 + add_real_number_2
        print(add_number_1, "+", add_number_2, "is", addition)

        if addition == 42069 or addition == 420 or addition == 69:
            print("stop"*100)
